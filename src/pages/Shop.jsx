  ...
  return (
    <div style={{ background: '#080808', minHeight: '100vh' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Filters Bar */}
        <div
          className="flex flex-col md:flex-row gap-3 mb-8 p-4 rounded-2xl"
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs whitespace-nowrap" style={{ color: '#666', fontFamily: 'DM Sans' }}>
              Max ₹{priceMax}
            </span>
            <input
              type="range"
        ...
        {/* Category pills (only shown on /shop) */}
        {!categoryFilter && (
          <div className="flex gap-2 mb-8 flex-wrap">
            {['all', 'wall-sticker', 'tshirt'].map(cat => (
              <button
                key={cat}
              ...
              >
                {cat === 'all' ? 'All' : cat === 'wall-sticker' ? 'Stickers' : 'T-Shirts'}
              </button>
            ))}
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            ...
            <p className="text-lg font-bold mb-2" style={{ fontFamily: 'Syne', color: '#555' }}>
              Nothing found
            </p>

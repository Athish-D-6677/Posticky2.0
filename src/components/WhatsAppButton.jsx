...
export default function WhatsAppButton() {
  const href = `https://api.whatsapp.com/send?phone=${WHATSAPP}&text=Hi%21+I+need+help+with+my+order.`
  ...
  return (
    <a
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.boxShadow = '0 0 35px rgba(37,211,102,0.6), 0 4px 20px rgba(0,0,0,0.4)'
      }}
      onMouseLeave={e => {
        e.currentTarget.style.transform = 'scale(1)'
        e.currentTarget.style.boxShadow = '0 0 20px rgba(37,211,102,0.4), 0 4px 15px rgba(0,0,0,0.3)'
      }}
    >
